...
create table parser_category (id bigint generated by default as identity,name varchar(255),primary key (id));
...
alter table order_links add constraint FKk7aeo7rg4pqknd4d8fxt761cu foreign key (category_id) references parser_category;
...
alter table site_category add constraint FKodgp196090vl00kr3kg08wruw foreign key (category_id) references parser_category;
...
insert into parser_category(id,name) values(1,'Разработка сайтов');
insert into parser_category(id,name) values(2,'Разработка');
