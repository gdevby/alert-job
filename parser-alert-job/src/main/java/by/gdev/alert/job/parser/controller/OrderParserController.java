...
import by.gdev.alert.job.parser.service.order.FLOrderParser;
import by.gdev.alert.job.parser.service.order.FreelanceRuOrderParser;
import by.gdev.alert.job.parser.service.order.FreelancehuntOrderParcer;
import by.gdev.alert.job.parser.service.order.FreelancerOrderParser;
import by.gdev.alert.job.parser.service.order.HabrOrderParser;
import by.gdev.alert.job.parser.service.order.KworkOrderParcer;
import by.gdev.alert.job.parser.service.order.PeoplePerHourParser;
import by.gdev.alert.job.parser.service.order.TruelancerOrderParser;
import by.gdev.alert.job.parser.service.order.WeblancerOrderParcer;
import by.gdev.alert.job.parser.service.order.YouDoOrderParcer;
