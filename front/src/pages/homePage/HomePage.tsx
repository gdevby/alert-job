      ...
      <div className="homePage_content">
        ...
        <h3>
          ...
          <ul className="home-page_content_list">
            ...
            <li>
              Своевременно уведомлять о заказе, без необходимости постоянно мониторить заказы каждый день и тратить
              личное время.
            </li>
            <li>Получать уведомления в удобную систему для вас: почта, телеграм. Можем расширить список.</li>
          </ul>
        </h3>
        <p className="mt-1 currentSites">
          Если вы ищите заказы каждый день в ручном режиме, то попробуйте переложить поиск на наш сервис. Мы его
          разрабатывали для своих нужд и мы его используем каждый день. Доступны заказы для следующих бирж (если вы
          хотите видеть заказы с других бирж сообщите нам):
        </p>
        <ul className="home-page_content_list">
          {sites.map(item => {
            return (
