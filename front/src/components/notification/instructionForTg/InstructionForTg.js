	...
	return <div className='instruction mt-1'>
		...
		<div className='instruction__list-block'>
			<ol className='instruction__list'>
				...
				<img src={alertBot} />
				<li>
					После этого нажмите кнопку <b>"Отправить тестовое уведомление"</b> справо вверху, чтобы было отправлено тестовое уведомление. Если сообщения не придёт, то проверьте спам(если выбрана почта).
				</li>
			</ol>
		</div>
	</div>
