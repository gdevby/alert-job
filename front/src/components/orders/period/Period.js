...
const Period = ({updatePeriod}) => {
	const [currentPeriod, setPeriod] = useState(7)
	...
	return (
		<div className='orders__period'>
			<p>Выберите период, за который вам будут показовать заказы ниже. От 1 дня до 30. С временем оно накапливает для вашего источника заказы, поэтому иногда старые сразу не будут доступны.</p>
